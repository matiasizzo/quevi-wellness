...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    body: [
      ...
      'En QUEVI, el N-GENE es una de las tres tecnologías del diagnóstico SKIN-SCAN Multiespectral, junto al análisis facial 3D AURA y la espectrofotometría OligoCheck. El médico cruza los tres resultados con tu historia clínica para emitir un juicio clínico real — no una recomendación comercial.',
  ...
  },
  {
    ...
    body: [
      ...
      '¿Es para ti? Si buscas mejorar calidad de piel general, calmar inflamación o potenciar otros tratamientos, probablemente sí. La frecuencia ideal — entre 1 sesión semanal y 1 mensual — la define el médico tras el diagnóstico SKIN-SCAN.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      'SEFFILLER forma parte del pilar REPAIR de QUEVI y requiere valoración médica previa con el diagnóstico SKIN-SCAN Multiespectral. Porque regenerar bien empieza siempre por diagnosticar bien.',
    ],
  },
]
