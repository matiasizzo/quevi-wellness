  ...
  return (
    <div className="space-y-3">
      <button
        ...
        className="w-full flex items-center justify-center gap-3 rounded-full bg-cream-50 border border-cream-400 px-4 py-3 text-[12px] tracking-[0.06em] uppercase text-carbon-900 hover:border-brand-400 hover:shadow-sm transition-all"
      >
        <GoogleIcon />
